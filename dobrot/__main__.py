...
from dobrot.plugins.new_join_fn import new_join_f, help_message_f, rename_message_f
from dobrot.plugins.incoming_message_fn import incoming_message_f, incoming_youtube_dl_f
from dobrot.plugins.status_message_fn import (
    status_message_f,
    cancel_message_f,
    exec_message_f,
    upload_document_f
)
from dobrot.plugins.call_back_button_handler import button
from dobrot.plugins.custom_thumbnail import (
    save_thumb_nail,
    clear_thumb_nail
)
